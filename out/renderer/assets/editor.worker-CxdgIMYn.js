(function() {
  ...
  class Stacktrace {
    static create() {
      var _a2;
      const err = new Error();
      return new Stacktrace((_a2 = err.stack) !== null && _a2 !== void 0 ? _a2 : "");
    }
    constructor(value) {
      this.value = value;
    }
  ...
  class Emitter {
    constructor(options) {
      ...
      this._leakageMon = ((_a2 = this._options) === null || _a2 === void 0 ? void 0 : _a2.leakWarningThreshold) ? new LeakageMonitor((_b2 = options === null || options === void 0 ? void 0 : options.onListenerError) !== null && _b2 !== void 0 ? _b2 : onUnexpectedError, (_d = (_c = this._options) === null || _c === void 0 ? void 0 : _c.leakWarningThreshold) !== null && _d !== void 0 ? _d : _globalLeakWarningThreshold) : void 0;
    ...
    get event() {
      ...
      (_a2 = this._event) !== null && _a2 !== void 0 ? _a2 : this._event = (callback, thisArgs, disposables) => {
        ...
        if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
          ...
          console.warn(message);
          const tuple = (_a3 = this._leakageMon.getMostFrequentStack()) !== null && _a3 !== void 0 ? _a3 : ["UNKNOWN stack", -1];
          const error = new ListenerRefusalError(`${message}. HINT: Stack shows most frequent listener (${tuple[1]}-times)`, tuple[0]);
          const errorHandler2 = ((_b2 = this._options) === null || _b2 === void 0 ? void 0 : _b2.onListenerError) || onUnexpectedError;
          errorHandler2(error);
  ...
  function findSectionHeaders(model, options) {
    var _a2;
    let headers = [];
    if (options.findRegionSectionHeaders && ((_a2 = options.foldingRules) === null || _a2 === void 0 ? void 0 : _a2.markers)) {
